...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-600 via-indigo-900 to-purple-900">
      <motion.div
      ...
      >
        ...
        <form className="space-y-4" onSubmit={handleRegister} autoComplete="on">
          ...
          {confirmError && (
            <div className="text-red-500 text-xs pl-2 mt-1">{confirmError}</div>
          )}
          <AnimatePresence>
            {error && (
              <motion.div
